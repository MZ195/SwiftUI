        ...
        VStack {
            ...
            VStack(spacing: 16){
                ...
                Color.white
                    ...
                    .background(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.7882352941, green: 0.8196078431, blue: 0.862745098, alpha: 1)), Color(#colorLiteral(red: 0.8705882353, green: 0.8901960784, blue: 0.9294117647, alpha: 1))]), startPoint: .top, endPoint: .bottom))
                    .cornerRadius(12)
