...
//  FIrstBoy
//
//  Created by Mazen .A on 26/02/2020.
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 20) {
                RingView(showProgress: $showProgress, color1: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), color2: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), width: 88, height: 88, percent: 78)
