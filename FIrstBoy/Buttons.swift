...
//  FIrstBoy
//
//  Created by Mazen .A on 30/03/2020.
...
struct Buttons: View {
    ...
    var body: some View {
        ...
        .background(Color(#colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1.0, alpha: 1.0)))
...
struct RectangleButton: View {
    ...
    var body: some View {
        Text("Button")
            ...
            .shadow(color: Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.7607843137, green: 0.8156862745, blue: 0.9254901961, alpha: 1)), radius: 20, x: 20, y: 20)
...
struct CircleButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)), Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1.0, alpha: 1.0))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                ...
                Circle()
                    ...
                    .shadow(color: Color(press ? #colorLiteral(red: 0.7607843137, green: 0.8156862745, blue: 0.9254901961, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius: 3, x: 3, y: 3)
            }
        )
            .clipShape(Circle())
